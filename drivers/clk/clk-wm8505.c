...
static const struct wm8505_clk_desc wm8505_gated_div_clks[] __initconst = {
	...
	DEF_GATED_DIV(WM8505_CLK_MAC0, "mac0", "osc25m", PMCEU_REG, 20, 0x32c, 0x1f, CLK_IS_CRITICAL),
	DEF_GATED_DIV(WM8505_CLK_NAND, "nand", "pllb", PMCEU_REG, 16, 0x330, 0x1f, CLK_IS_CRITICAL),
	DEF_GATED_DIV(WM8505_CLK_NORGUP, "nor_gup", "pllb", PMCEU_REG, 3, 0x334, 0x1f, CLK_IS_CRITICAL),
	...
	DEF_GATED_DIV(WM8505_CLK_DVO, "dvo", "pllc", PMCEL_REG, 18, 0x374, 0x1f, CLK_IS_CRITICAL | CLK_SET_RATE_PARENT),
};
